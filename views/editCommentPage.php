	...
	<div class="limiter">
		<div class="container-login100">
			<div style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.3);   border-radius: 3rem;"class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form action="../controller/cmtApi/updateComment.php?cmt_id=<?php echo $_GET['cmt_id'];?>&post_id=<?php echo $_GET['post_id']?>" method="post" class="login100-form validate-form flex-sb flex-w">
					<?php
					...
					<div class="wrap-input100 validate-input m-b-12" data-validate = "Cannot be empty">
						<input class="input100" type="text" name="comment" value="<?php echo $old_comment; ?>">
