	...
	<div class="card p-5" style="border-radius: 1rem; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.3);">
		...
		?>
				<div class="row ml-2 mb-3">
					<img src="../images/profilepic/<?php echo $profilepic;?>" style="width: 250px; height: 250px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.3);border-radius: 7rem;">
				</div>
		<?php
			} else {
		?>
				<div class="row ml-2 mb-3">
					<img src="img/nfprofile.gif" style="width: 250px; height: 250px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.3);border-radius: 7rem;">
				</div>
		<?php
			}
		?>
